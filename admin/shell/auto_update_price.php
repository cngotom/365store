...
#$db->query("update ".$ecs->table('goods')." set is_on_sale = 0");

$goods_list = (get_all_goods("../data/newprice.csv"));
            ...
            else
            {
             ...
             if($line_list[1] == 3 )
                $arr['is_on_sale'] = 1;
                 ...
                 $arr['is_on_sale'] = 0;
             $arr['shop_price'] = trim($line_list[2]);
             if( floatval( $arr['shop_price'] ) == 0 )
                   $arr['is_on_sale'] = 0;
             $arr['market_price'] = $arr['shop_price'] * 1.2;
