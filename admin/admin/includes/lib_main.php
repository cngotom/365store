 ...
 */
function create_html_editor($input_name, $input_value = '',$prefix = '')
{
    global $smarty;
    ...
    $smarty->assign($prefix.'FCKeditor', $FCKeditor);
}
/**
 * 生成编辑器
 * @param   string  input_name  输入框名称
 * @param   string  input_value 输入框值
 */
function create_front_html_editor($input_name, $input_value = '',$prefix = '')
{
    global $smarty;
