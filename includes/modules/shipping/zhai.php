 ...
 * ============================================================================
 * $Author: guotao $
 * $Id: zhai.php 17217 2012-04-14 02:09:08Z guotao $
*/

$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/zhai.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.365store.com';

    /* 配送接口需要的参数 */
    $modules[$i]['configure'] = array(
                                    array('name' => 'item_fee',     'value'=>10),    /* 单件商品配送的价格 */
                                    array('name' => 'base_fee',    'value'=>10),    /* 1000克以内的价格 */
                                    array('name' => 'step_fee',     'value'=>1),    /* 续重每1000克增加的价格 */
                                );
...
class zhai
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.kiees.cn/zjs.php" name="queryForm_' .$invoice_sn. '" target="_blank">'.$invoice_sn.
            '<input type="hidden" name="wen" value="' .str_replace("<br>","\n",$invoice_sn). '" />'.
            '<a href="javascript:document.forms[\'queryForm_' .$invoice_sn. '\'].submit();"> 点击查看</a>'.
            '</form>';
