...
function insert_cart_info()
{
    ...
    $promotestr = sprintf($GLOBALS['_LANG']['cart_info'], $number, price_format($amount, false));
...
function insert_comments($arr)
{
    ...
    $GLOBALS['smarty']->assign('username',     stripslashes(GLogin::name()));
    $GLOBALS['smarty']->assign('email',        GLogin::email());
