...
class cls_image
{
     ...
     */
    function make_thumb_keep_ratio($img, $thumb_width = 0, $thumb_height = 0, $path = '', $bgcolor='')
    {
        ...
        $src_ratio =  $org_info[0] / $org_info[1]  ;
        $dst_ratio = $thumb_width / $thumb_height;
        
       // echo "w:$thumb_width  h:$thumb_height<br>";
      //    echo "src_ratio : ".$src_ratio."dst_ratio: ".$dst_ratio."<br>";
        if($src_ratio > $dst_ratio)
        {
            $ratio =  $org_info[0] / $thumb_width ;
            return $this->make_thumb($img,  $thumb_width, $org_info[1] /  $ratio);
            
        }
        else {
            $ratio =  $org_info[1] / $thumb_height ;
            return $this-> make_thumb($img,  $org_info[0] /  $ratio, $thumb_height );
        }
