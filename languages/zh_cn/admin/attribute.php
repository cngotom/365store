...
$_LANG['note_attr_type'] = '选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，用户只能查看该值。使用多个属性时，该属性只作为自然属性，并不对应新的价格';
$_LANG['attr_type_values'][0] = '唯一属性';
$_LANG['attr_type_values'][1] = '单选属性';
$_LANG['attr_type_values'][2] = '复选属性';
$_LANG['attr_type_values'][3] = '多个属性';
