...
$_LANG['shopping_and_other'] = '购买此商品的人还购买过';
...
$_LANG['shippay_methods'] = '支付及配送方式';
$_LANG['fapiao_methods'] = '发票信息';
$_LANG['jiesuan_methods'] = '结算信息';
...
//-- tab页码
/*------------------------------------------------------ */
$_LANG['goods_tab_comment'] = '用户评论';
$_LANG['goods_tab_buy'] = '如何购买';
$_LANG['goods_tab_knowledge'] = '健康常识'; 
$_LANG['goods_tab_advice'] = '营养师建议';
?>