 ...
 **/
    jQuery.fn.jqUploader = function(options) {
        return this.each(function(index) {
            ...
            var startMessage = ($thisLabel.text() =='') ? '请选择图片文件' : $thisLabel.text();
            ...
            var opts = jQuery.extend({
                ...
                errorSizeMessage: '文件太大，网络传输缓慢，请压缩处理后上传!',
                validFileMessage: '点击upload开始上传',
                progressMessage: '上传中，请稍后...',
            ...
            TerminateJQUploader = function(containerId,filename,varname){
                ...
                $this.text('').append('<div style="color:#00CC00">上传成功，请稍候...</div>');
                ...
                window.parent.UploadImg.callback_upload(opts.picid,opts.newfilename);
            }
            var myParams = '';
