...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,listtable.js,../js/jquery-1.7.2.min.js')); ?>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  <tr>
    ...
    <th><?php echo $this->_var['lang']['handler']; ?>&nbsp;<a href="javascript:void(0)" id="show_all_btn">显示全部</a></th>
  </tr>
...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?> <?php if ($this->_var['cat']['is_show'] != '1'): ?>hide_row<?php endif; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>"  >
...
onload = function()
{
  ...
  $("tr.0").each(function(index,ele){
      
      rowClicked($(ele).find("img:first")[0] );
  });
  $("tr.hide_row").hide();
  
  $('#show_all_btn').click(function(){
      if( $('#show_all_btn').html() == "显示全部" )
      {
        $("tr.hide_row").show();
        $("tr.0").each(function(index,ele){
