...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td scope="col"><div align="center"><strong> 重量 </strong></div></td>
...
?>
  <tr>
    ...
    <a href="<?php echo ADMIN_ROOT_HOST; ?>/goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?> <?php if ($this->_var['goods']['brand_name']): ?>[ <?php echo $this->_var['goods']['brand_name']; ?> ]<?php endif; ?>
...
?>
  ...
  <!--  <td> $goods.product_sn </td> -->
    <td> <?php echo $this->_var['goods']['link']; ?> </td>
    ...
    <td><?php echo $this->_var['goods']['goods_weight']; ?>kg</td>
  ...
  <tr>
    ...
    <td colspan="2"><div align="right"><?php echo $this->_var['order']['formated_goods_amount']; ?></div></td>
  </tr>
</table>
</div>
...
<?php if ($this->_var['operable_list']['back_bank_ing'] || $this->_var['operable_list']['back_bank_done']): ?>
    <div class="list-div" style="margin-bottom: 5px">
    ...
    <tr>
     ...
     <tr>
         ...
         <td ><?php echo $this->_var['back_bank']['name']; ?></td>
         
         <td align="right"><strong> 账号:</strong></td>
         <td><?php echo $this->_var['back_bank']['card_no']; ?> </td>
     </tr>

      <tr>
         <td align="right"> <strong> 银行名称: </strong></td>
         <td ><?php echo $this->_var['back_bank']['bank_name']; ?></td>
         
         <td align="right"><strong> 开户地:</strong></td>
         <td><?php echo $this->_var['back_bank']['location']; ?> </td>
     </tr>
     
      <tr>
         <td align="right"> <strong> 金额总计: </strong></td>
         <td >￥<?php echo $this->_var['back_bank']['money']; ?></td>
         <?php if ($this->_var['operable_list']['back_bank_ing']): ?>
         <td align="right"><strong> 应退金额:</strong></td>
         <td>￥<?php echo $this->_var['back_bank']['return_money']; ?> </td>
         <?php else: ?>
          <td align="right"><strong> 已退金额:</strong></td>
         <td>￥<?php echo $this->_var['back_bank']['money_paid']; ?> </td>
         <?php endif; ?>
     </tr>
     
       <tr>
         <td align="right"> <strong> 申请时间: </strong></td>
         <td ><?php echo $this->_var['back_bank']['create_time']; ?></td>
         
         <td align="right"><strong>退款时间:</strong></td>
         <td><?php echo $this->_var['back_bank']['back_time']; ?>  </td>
     </tr>
     
      <tr>
         <td align="right"> <strong> 手机: </strong></td>
         <td ><?php echo $this->_var['back_bank']['mobile']; ?></td>
         
         <td align="right"><strong>原因:</strong></td>
         <td><?php echo $this->_var['back_bank']['reason']; ?>   </td>
     </tr>
  ...
  <tr>
    ...
    <td colspan="5"><?php if ($this->_var['operable_list']['confirm']): ?>
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="button" />
        ...
        <?php endif; ?><?php if ($this->_var['operable_list']['back_bank_ing']): ?>
        <input name="back_bank_ing" type="submit" value="<?php echo $this->_var['lang']['op_back_bank']; ?>" class="button" />
