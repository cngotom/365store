...
<?php echo $this->smarty_insert_scripts(array('files'=>'js/utils.js,.js/transport_old.js,validator.js,js/common.js')); ?>
...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/transport_old.js,../js/region.js')); ?>
