...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        class="tab-back" id="advice-tab"><?php echo $this->_var['lang']['tab_advice']; ?></span><span
...
?>
        ...
        <table width="90%" id="detail-table" style="display:none">
          <tr>
            <td><?php echo $this->_var['descFCKeditor']; ?></td>
          </tr>
        </table>
        
        <!-- 营养师建议 -->
        <table width="90%" id="advice-table" style="display:none">
          <tr>
            <td><?php echo $this->_var['adviceFCKeditor']; ?></td>
          </tr>
        </table>
...
function validate_edit_logo(a){
    ...
    alert("图片类型必须是.gif,jpeg,jpg,png中的一种")
        ...
        if(width>80 && height>80 && filesize>max_upload_size){
  ...
  {
    //  var a =FCKeditorAPI.GetInstance('goods_desc').GetXHTML(); alert(a); return false;
      //上传图片大小判断 
