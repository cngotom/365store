...
<div class="box">
 <div class="box_1">
  <div class="mt"><span title="<?php echo $this->_var['linked']['title']; ?>"><?php echo sub_str($this->_var['linked']['title'],11); ?></span></div>
...
?>
  <ul class="clearfix">
      <li class="goodsimg">
      <a href="{NGINX_IMG_HOST}<?php echo $this->_var['linked_goods_data']['url']; ?>" target="_blank"><img  src="<?php echo NGINX_IMG_HOST; ?><?php echo $this->_var['linked_goods_data']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['linked_goods_data']['name']); ?>" class="B_blue" /></a>
      </li>
      <li>
