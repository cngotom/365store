...
<span class="jia" id="jia">+</span>
                     <?php if (0 && $this->_var['goods']['give_integral'] > 0): ?>  <span class="bg"><a class="s7"></a></span> <span>购买此商品 赠送<?php echo $this->_var['goods']['give_integral']; ?> <?php echo $this->_var['points_name']; ?></span><?php endif; ?>
                   </div>
           ...
           <div class="others_like">
               ...
               <ul>
                     <?php $_from = $this->_var['bought_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_38085200_1358433727');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_38085200_1358433727']):
        $this->_foreach['foo']['iteration']++;
?>
                       <?php if (($this->_foreach['foo']['iteration'] - 1) <= 4): ?>
                            <li>
                                <div class="sales_list">
                                    <div><a href="<?php echo $this->_var['goods_0_38085200_1358433727']['url']; ?>"><img src="<?php echo $this->_var['goods_0_38085200_1358433727']['goods_thumb']; ?>" height="100px"  alt="<?php echo htmlspecialchars($this->_var['goods_0_38085200_1358433727']['goods_name']); ?>"/></a></div>
                                        <div class="sales_info1">
                                            <span><a href="<?php echo $this->_var['goods_0_38085200_1358433727']['url']; ?>"><?php echo htmlspecialchars($this->_var['goods_0_38085200_1358433727']['short_name']); ?> </a></span>
                                        </div>
                                        <div class="sales_info2">
                                            <span style="color: red;font-size: 20px;"><?php echo $this->_var['goods_0_38085200_1358433727']['shop_price']; ?></span>
                                        </div>
                                        <div class="sales_info1">
                                            <span class="bg"><a  onclick="javascript:addToCart(<?php echo $this->_var['goods_0_38085200_1358433727']['goods_id']; ?>)" class="s11"></a></span>
                                        </div>
                                    </div>    
                            </li>
                       <?php endif; ?>
