<div class="common-menu">
    管理收货地址&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->createUrl('userMenu/addAddress',array('from'=>'cart'));?>">添加+</a></div>
<?php if ( !empty($msg) ) { ?>
      ...
      <?php  foreach ($addressList as $address) {  ?>
        <div class="order-intro">
            <ul>
                ...
                <li class="operation"><a href="<?php echo $this->createUrl('confirmAddress',array("address_id"=>$address->address_id));?>">
                    确认</a><a href="<?php echo $this->createUrl('userMenu/addAddress',array("address_id"=>$address->address_id,'from'=>'cart'));?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    修改</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo $this->createUrl('userMenu/deleteAddress',array("address_id"=>$address->address_id,'from'=>'cart'));?>">
                        删除</a>
